...
GUIController c;
IFLabel lbl_uid, lbl_uid_msg, lbl_error_success_msg, lbl_heading, lbl_uid_txt;
...
void userForm() {
  ...
  lbl_heading = new IFLabel("User UID Pay Panel", 230, 20);
  ...
  btn_addUser = new IFButton("Pay", 200, 190, 80, 20);
